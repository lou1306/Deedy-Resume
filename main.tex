...
\newcommand{\comboJob}[5]{%\combosection{#1}{#2}{#4 • #3}{#5}\vspace{\topsep}
\runsubsection{#1}
\descript{#2}
\location{#3 • #4}
...
\newcommand{\comboJobZero}[5]{\comboJob{#1}{#2}{#3}{#4}{#5}}
...
AAMAS\@, ICSOFT\@, ISoLA\@, SEFM\@, TACAS\@, TASE
\sectionsep%

\subsection{Journal Referee}

Log. Methods Comput. Sci, Sci. Comput. Program.
