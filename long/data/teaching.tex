\comboJob
{TU Wien}
{MSc course in GPU Architectures and Computing}
{\MONTH{4} – \MONTH{7} 2024}
{Vienna, \AT}
{
\ifLong{%
% \cvline{
...
\ifShort{%
\begin{tightemize}
\item[] Introduction to GPU hardware architectures and CUDA programming
\item[] Approx. 30 hours of teaching assistance (support and grading of group projects)
}
}
