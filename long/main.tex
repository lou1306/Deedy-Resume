...
% Publications %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage[doi=false,bibstyle=publist,plnumbered=false,plauthorhandling=highlight,boldyear=false,nameorder=given-family,linktitledoi=true,maxbibnames=99]{biblatex}
...
I have reviewed submissions to the following conferences and journals:
